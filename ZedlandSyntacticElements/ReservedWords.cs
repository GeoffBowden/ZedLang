...
namespace ZedLangSyntacticElements
{
    public static class ExtensionMethodsForReservedWords
    {
        ...
        public static bool IsANot(this string word)
        {
            return (string.Compare( word, "not", StringComparison.OrdinalIgnoreCase )==0);
        }
        public static bool IsaReservedWord(this string word)
        {
            return ReservedWords.Contains(word.ToLower());
        }
        public static bool IsNotAReservedWord(this string word)
        {
            return !IsaReservedWord(word);
        }
